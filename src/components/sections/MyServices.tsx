...
const MyServices = () => {
  return (
    <section
      className="bg-primaryBgColor text-textColor min-h-screen pt-28 sm:pt-32 px-[9%] pb-1 md:pb-5 flex flex-col items-center"
      id="serviços"
    >
      <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-16 sm:mb-32">
